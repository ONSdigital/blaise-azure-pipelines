function ServerParkExists {
    ...
    -server:blaise-gusty-mgmt.europe-west2-a.c.ons-blaise-v2-dev-multinode.internal -user:REDACTED_USER -password:REDACTED_PASSWORD -binding:http -port:8031 | findstr -i "cma2"
