...
$blaiseInstallArgs += "COMPANYNAME=ONS"
$blaiseInstallArgs += "LICENSEE=ONS"
$blaiseInstallArgs += "SERIALNUMBER=$env:ENV_BLAISE_LICENSE_KEY"#
$blaiseInstallArgs += "ACTIVATIONCODE=$env:ENV_BLAISE_ACTIVATION_CODE"#
...
$blaiseInstallArgs += "MANAGEMENTCOMMUNICATIONPORT=$env:ENV_MANAGEMENTCOMMUNICATIONPORT"
...
$blaiseInstallArgs += "ADMINISTRATORUSER=$env:ENV_BLAISE_ADMIN_USER"
$blaiseInstallArgs += "ADMINISTRATORPASSWORD=$env:ENV_BLAISE_ADMIN_PASS"
